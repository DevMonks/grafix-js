/*
 ...
 This class is only for calculating single key positions of a spline in order to
 create smooth animations.

 The Easing class uses this to create pre-defined easings

 */

var KeySpline = function (x1, y1, x2, y2, epsilon)
{
    epsilon = epsilon || 0.002; // default precision
